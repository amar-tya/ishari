...
import { ChapterMediaEntity, HadiEntityList } from '@/core/entities';
import { AudioPlayer } from '../verse-media';

interface ChapterMediaListProps {
  mediaList: ChapterMediaEntity[];
  hadiList: HadiEntityList | null;
  onEdit: (id: number) => void;
  onDelete: (id: number) => void;
}

export const ChapterMediaList: React.FC<ChapterMediaListProps> = ({
  mediaList,
  hadiList,
  onEdit,
  onDelete,
                ...
                >
                  ...
                  <td className="py-4 px-[clamp(1rem,1.5vw,1.5rem)]">
                    <div className="text-subtitle font-semibold text-text-primary">
                      {media.chapter?.title || media.chapterId}
                    </div>
                  </td>
                  <td className="py-4 px-[clamp(1rem,1.5vw,1.5rem)]">
